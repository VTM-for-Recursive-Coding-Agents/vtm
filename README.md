...
- `vtm_dspy`: optional DSPy ReAct integration on top of the VTM kernel
...
SWE-bench Lite was attempted as an external agent pilot, but it produced empty patches and zero resolved tasks. It is not part of the final maintained benchmark surface or paper claim.
...
- [docs/dspy-integration.md](docs/dspy-integration.md): optional DSPy ReAct integration notes
