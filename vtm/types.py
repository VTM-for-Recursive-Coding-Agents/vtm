...
class ArtifactRef:
    ...
    env_hash: str | None = None # the ev_hash is used to document changes to the artifact
    dependencies: list[str] | None = None # the list of dependencies (artifacts, code anchors, etc.) required for the artifact to run
...
class Memory:
    ...
    evidence: list[dict[str, Any]] = field(default_factory=list) # the evidence for the memory
